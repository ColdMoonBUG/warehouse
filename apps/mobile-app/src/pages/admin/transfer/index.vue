<template>
  <view class="page">
    <view class="header">
      ...
      <text class="title">调拨单</text>
      <view style="width: 60rpx" />
    </view>
    <view class="content">
      <view class="actions"><button class="btn" @tap="goCreate">新增调拨单</button></view>
...
function goCreate() { uni.navigateTo({ url: '/pages/admin/transfer/form' }) }
function goEdit(doc: TransferDoc) { uni.navigateTo({ url: `/pages/admin/transfer/form?id=${doc.id}` }) }
